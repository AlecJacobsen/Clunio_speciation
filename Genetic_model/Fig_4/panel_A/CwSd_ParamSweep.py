...
def slim_command(pop_size = 10, mu = 1e-7, r = 1e-7, lunar_qtl_effect_sd = 0.5, lunar_qtl_proportion = 0.1, day_sd = 0.25, day_mating_interaction_sd = 0.00000001,  Cw = 0.5, initial_x = 15, initial_y = 0, disp_sd = 0.1, K = 200, num_kids = 10, total_gens = 1500):
    slim_command = """
slim \
-d pop_size=%s \
-d mu=%s \
